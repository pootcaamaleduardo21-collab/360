...
-- ─── Migration 8: Team announcements (Novedades) ──────────────────────────────
-- Admin can post news, announcements and motivational messages for their team.
...
-- Admin has full control over their own announcements
...
-- Advisors can read their admin's announcements
...
-- Index for fast lookups per admin
